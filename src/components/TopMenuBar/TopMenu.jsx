    ...
    <>
      ...
      >
        ...
        <div className="user-list">
            ...
            <ul>
                <li><a href="profile.html"><i className="fa fa-user"></i> Profile</a></li>
                <li><a href="change_password.html"><i className="fa fa-lock"></i> Change Password</a></li>
                <li><a onClick = {() => 
                localStorage.clear()} href="/Login"><i className="fa fa-power-off"></i> Logout</a></li>
            </ul>
        </div>
    </div>
      </header>
